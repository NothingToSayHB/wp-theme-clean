...
function clean_scripts() {
	...
	wp_enqueue_style( 'clean-iccomon', get_template_directory_uri() . '/assets/css/icomoon.css' );

	wp_enqueue_style( 'clean-simple-line-icons', get_template_directory_uri(). '/assets/css/simple-line-icons.css' );

	wp_enqueue_style( 'clean-g-style', get_template_directory_uri() . '/assets/css/style.css');

	wp_enqueue_script( 'clean-modernizr-script', get_template_directory_uri() . '/assets/js/modernizr-2.6.2.min.js', array(), '20151215', false );

	wp_deregister_script('jquery');
    wp_register_script('jquery', get_template_directory_uri() . '/assets/js/jquery.min.js');
	wp_enqueue_script('jquery');
	
	wp_enqueue_script( 'clean-easing-script', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', ['jquery'], null, true );

	wp_enqueue_script( 'clean-bootstrap-script', get_template_directory_uri() . '/assets/js/bootstrap.min.js', ['jquery'], null, true );
	
	wp_enqueue_script( 'clean-waypoints-script', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', ['jquery'], null, true );

	wp_enqueue_script( 'clean-main-script', get_template_directory_uri() . '/assets/js/main.js', ['jquery'], null, true );
